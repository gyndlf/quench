...
class MDACBasicChannel(InstrumentChannel):
...
class MDACChannel(MDACBasicChannel):
...
class Trigger(InstrumentChannel):
    ...
    def _get_trigger(self):
        ...
        # trigger[3,4] is the period in seconds, ticks
...
class MDAC(VisaInstrument):
    ...
    def __init__(self, name, address, baudrate=460800, debug=False,
        ...
        if (self._mdac_variant != 'MDAC8'):
            ch_isense = MDACBasicChannel(self, 'ch_isense', 0)
